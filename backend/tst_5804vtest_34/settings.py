"""
Django settings for tst_5804vtest_34 project.
...
ROOT_URLCONF = 'tst_5804vtest_34.urls'
...
WSGI_APPLICATION = 'tst_5804vtest_34.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-5804Vtest Support <support@tst-5804vtest-34.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_5804vtest_34 API",
    "DESCRIPTION": "API documentation for tst_5804vtest_34 App",
    "VERSION": "v1",
}
